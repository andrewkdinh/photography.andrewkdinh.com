        ...
        $this.find(settings.selector).each(function(index) {
            ...
            switch (x.type) {
                ...
                case 'soundcloud':
                    ...
                    x.src = 'https://w.soundcloud.com/player/?url=' + escape(x.src) + (x.options ? '&' + x.options : '');
                    x.width = '600';
                    x.height = "166";
                ...
                case 'youtube':
                    ...
                    x.src = 'https://www.youtube.com/embed/' + tmp[1]  + (x.options ? '?' + x.options : '');
                ...
                case 'vimeo':
                    x.object = $('<iframe src="" frameborder="0" allowFullScreen="1"></iframe>');
                    x.src = 'https://player.vimeo.com/video/' + tmp[1]  + (x.options ? '?' + x.options : '');
                ...
                case 'wistia':
                    x.object = $('<iframe src="" frameborder="0" allowFullScreen="1"></iframe>');
                    x.src = 'https://fast.wistia.net/' + tmp[1] + (x.options ? '?' + x.options : '');
                ...
                case 'bcove':
                    ...
                    x.src = 'https://bcove.me/' + tmp[1] + (x.options ? '?' + x.options : '');
